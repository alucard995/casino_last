<?if(!core\auth\auth::authCheck()):?>
	...
	<div class="auth_form_wrapper">
		...
		<form class="auth_form" name="auth" action="#" method="post">
			...
			<div class="index_form_string">
				<input class="index_form_input" type="password"  name="pass" placeholder="Password:" required>
			</div>
			<div class="index_form_string">
	...
	<div class="auth_form_wrapper">
		...
		<form class="auth_form" name="reg" action="#" method="post">
			...
			<div class="index_form_string">
				<input class="index_form_input" type="password"  name="pass1" placeholder="Password:" required>
			</div>
			<div class="index_form_string">
				<input class="index_form_input" type="password"  name="pass2" placeholder="Confirm password:" required>
			</div>
			<div class="index_form_string">
